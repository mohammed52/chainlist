var ChainList = artifacts.require("./ChainList.sol"); // load the chainlist contract from the source folder

// test suite
contract('ChainList', function(accounts){ //1st arg: name of the contract to test, second: method with list of eth_accounts
  // available on the test node
